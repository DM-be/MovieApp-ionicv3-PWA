...
@Directive({
  selector: '[imgpreload]', //E.g <img mg-img-preloader="http://some_remote_image_url"
  host: {
...
export class ImagePreload implements OnInit {
  @Input('imgpreload') targetSource: string;
